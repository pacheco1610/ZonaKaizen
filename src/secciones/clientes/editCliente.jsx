...
function EditCliente(props) {
    ...
    useEffect(() => {
        ...
        props.tareas.map(tarea => {
            if (tarea.clienteRelacionado.key !== undefined) {
                if (tarea.clienteRelacionado.key === props.cliente.key) {
                    const listTareas = tareas
    ...
    return (
        <>
            <div className="flexbox-container">
                ...
                <div>
                    <div className="bg-principal p-2 rounded clientesArchivos">
                        {tareas.map(tarea=>
                           <div>aiuda</div>
                        )}
                    </div>
