...
function EdtiPerfil(props) {
    const [estado, setEstado] = useState({...props.editPuesto,responsabilidades:[]})
    useEffect(() => {
        setEstado({...props.editPuesto,responsabilidades:[]})
    }, [props.editPuesto])
    ...
    const addResponsabilidad = (tipo)=>{
        if (estado[tipo]!==""&&estado[tipo]) {
            const array=estado.responsabilidades
            array.push({
                key:numeroRandom(),
                responsabilidad:estado[tipo],
                tipo:tipo
            })
            setEstado({...estado,[tipo]:'',responsabilidades:array})
        }
    }
    const removeResponsabilidad = (responsabilidad)=>{
        setEstado({...estado,responsabilidades:estado.responsabilidades.filter(item=>item.key !==responsabilidad)})
    }
    const check=(habilidad)=>{
        estado.habilidades.map(habilidadFil=>{
            if (habilidadFil.key === habilidad.key) {
                habilidadFil.checked=!habilidadFil.checked;
                setEstado({...estado,habilidades:estado.habilidades})
            }
        })
    }
    const CrearPuesto = ()=>{
        ...
        if (verificador===0) {
            firebase.database().ref(`puestos/${props.editPuesto.uid}`).update(estado)
            .then(()=>{
                toggleAlert('sucefull','Actualizado correctamente')
            })
        }   
     

    }
   if (estado.habilidades) {
    return (
        <div className="row mb-5 pb-5">
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='General').map(responsabilidad=>
                        <div type="button"  
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='Diaria').map(responsabilidad=>
                        <div type="button"  
                        key={responsabilidad.key} 
                        className="col-12 btn btn-block bg-secundario text-white text-left mr-2 mb-2">
                            <span 
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='Semanales').map(responsabilidad=>
                        <div type="button"  
                        key={responsabilidad.key} 
                        className="col-12 btn btn-block bg-secundario text-white text-left mr-2 mb-2">
                            <span 
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='Quincenal').map(responsabilidad=>
                        <div type="button"  
                        key={responsabilidad.key} 
                        className="col-12 btn btn-block bg-secundario text-white text-left mr-2 mb-2">
                            <span 
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='Mensual').map(responsabilidad=>
                        <div type="button"  
                        key={responsabilidad.key} 
                        className="col-12 btn btn-block bg-secundario text-white text-left mr-2 mb-2">
                            <span 
            ...
            <div className="col-12 col-xl-12 col-md-12 mt-2">
                ...
                <div className="row">
                    {estado.responsabilidades.filter(item=>item.tipo==='Eventuales').map(responsabilidad=>
                        <div type="button"  
                        key={responsabilidad.key} 
                        className="col-12 btn btn-block bg-secundario text-white text-left mr-2 mb-2">
                            <span 
            ...
            {estado.habilidades.map(habilidad=>
                <div className="col-12 col-xl-6 col-md-4 mt-2" key={habilidad.titulo}>
                    <div className="form-check">
                        <input onChange={(e)=>check(habilidad)} id={habilidad.key} checked={habilidad.checked} className="form-check-input" type="checkbox" name={habilidad.key} />
            ...
            <div className="col-12 mt-4">
                <button className="btn bg-primary text-white btn-block" onClick={()=>CrearPuesto()}>Guardar Cambios</button>
            </div>
        </div>
    )
   }else{
       return(<Redirect to="/perfildepuestos" />)
   }
}
...
const PropsStore = state =>{
    return{
        ...
        editPuesto:state.puestos.editPuesto
    }
}
export default connect(PropsStore)(EdtiPerfil)